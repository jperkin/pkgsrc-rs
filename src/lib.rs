...
pub use crate::pattern::{BestMatch, Pattern, PatternCache, PatternError};
...
pub use crate::scanindex::{
    AllDepends, BootstrapPkg, MakeJobsSafe, Presolve, Pscan, RawDepend, Report,
    ScanDepends, ScanIndex, ScanIndexIter,
};
